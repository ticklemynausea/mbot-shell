...
tlInfoStyle = 'border-bottom:1px solid white; background-color:#e2e2e2;padding:2px; padding-left:6px;'

tlStarStyle = 'padding:2px;font-weight:bold; width: 27px; height: 25px; background-position:center; background-repeat:no-repeat; text-align:center; vertical-align:middle; background-image:url(/_media/img/2008/Jan/tmpl_fe_fundo_estrela_on_dwma2.jpg); '
...
res = soup.findAll('td', {'style': tlInfoStyle}) # totoloto info and joker(last)
...
res = soup.findAll('td', {'style': tlStarStyle}) # totoloto stars
